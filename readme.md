...
- `MEKARI_SYNC_ENDPOINT` (**wajib**): endpoint HTTP yang akan memicu sinkronisasi produk (misalnya webhook Supabase Edge Function/Cloud Run Anda).
- `MEKARI_SYNC_TOKEN` (opsional): token Bearer yang akan dikirimkan di header Authorization.
