...
## Alur singkat
1. Ambil semua produk dari tabel `products` beserta `variant_pricing`-nya (lead time utama di level varian).
...
3. Untuk setiap varian dengan `next_procurement > 0` dan `leadTime` (atau `lead_time`) valid, cari periode terdekat yang
