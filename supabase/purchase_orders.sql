...
drop policy if exists "Allow read purchase orders" on public.purchase_orders;
...
drop policy if exists "Allow read purchase order items" on public.purchase_order_items;
...
drop policy if exists "Allow read in transit stock" on public.in_transit_stock;
create policy "Allow read in transit stock"
