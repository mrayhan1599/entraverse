    ...
    .map(([dateKey, entries]) => {
      ...
      return `
        <tr class="procurement-date" data-date="${escapeHtml(dateKey)}">
          <td colspan="6">
            <button
              class="procurement-date__toggle"
              type="button"
              data-date-toggle="${escapeHtml(dateKey)}"
              aria-expanded="true"
            >
              <div class="procurement-date__info">
              ...
              <span class="procurement-date__chevron" aria-hidden="true"></span>
            </button>
          </td>
        </tr>
        ${rowsForDate}
